export default function Star ({ fill, stroke, className, ...props }: { fill: string, stroke: string, className: string }) {
    return (
        <svg {...props} className={className} version="1.0" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
            width="64px" height="64px" viewBox="0 0 64 64" enableBackground="new 0 0 64 64" xmlSpace="preserve">
        <g>
            <path fill={stroke} d="M49.302,63.999c-0.664,0-1.332-0.164-1.938-0.5l-15.365-8.498l-15.366,8.498
            ...
            <path fill={fill} d="M31.998,46.43c0.668,0,1.332,0.168,1.938,0.5l10.092,5.579l-1.98-12.119
                c-0.203-1.254,0.199-2.527,1.086-3.438l8.563-8.779l-11.654-1.781c-1.316-0.199-2.449-1.043-3.016-2.255l-5.028-10.712
                L26.97,24.137c-0.566,1.212-1.699,2.056-3.016,2.255L12.3,28.173l8.563,8.779c0.887,0.91,1.289,2.184,1.086,3.438l-1.98,12.119
                l10.092-5.579C30.666,46.598,31.33,46.43,31.998,46.43z"/>
        </g>
